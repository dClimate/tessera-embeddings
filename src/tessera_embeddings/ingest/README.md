...
[ingest-error-handling.md](../../../docs/ingest-error-handling.md) and [Performance Optimizations](#performance-optimizations) are the
rest.
...
- **Reads retry, per date**, and a failed date says which date and which ROI. See
  [ingest-error-handling.md](../../../docs/ingest-error-handling.md#where-the-retry-sits-and-how-a-failed-date-is-attributed).
