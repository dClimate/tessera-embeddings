...
(``context_docs/ingest/campaign-ingest-measurements.md``). This module is the pure
...
def merge_bands(
    ...
    *,
    ...
    Calibration, campaign-wide effect and cap sweep: ``context_docs/ingest/campaign-ingest-measurements.md``.
    """
    n = len(windows)
    if n == 0:
        return []
