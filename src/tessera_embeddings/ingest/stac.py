...
# Measurements in context_docs/ingest/campaign-ingest-measurements.md.
...
# in context_docs/ingest/campaign-ingest-measurements.md.
#
...
def _query_stac_items(
    ...
    # context_docs/ingest/campaign-ingest-measurements.md section 12.9.
