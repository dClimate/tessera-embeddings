...
def write_region(
    ...
    *,
    ...
    overwrites committed data — see ``context_docs/ingest/campaign-ingest-measurements.md`` for the
...
class RegionWriteBatch:
    ...
    ``context_docs/ingest/campaign-ingest-measurements.md``): the caller computes each window to
